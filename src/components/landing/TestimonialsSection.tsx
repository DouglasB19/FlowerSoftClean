...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: "Maria Silva",
    message: "Gente, meu sofá ficou INCRÍVEL!! Parece que comprei um novo 😍 super recomendo a Flower Soft Clean!",
    time: "14:32",
    rating: 5,
  },
  {
    id: 2,
    name: "João Santos",
    message: "Chamei pra limpar o colchão e fiquei impressionado com a quantidade de sujeira que saiu. Atendimento nota 10!",
    time: "09:15",
    rating: 5,
  },
  {
    id: 3,
    name: "Ana Oliveira",
    message: "Já é a terceira vez que chamo. Sempre pontuais e o resultado é perfeito. Meus tapetes ficam como novos! 👏",
    time: "16:47",
    rating: 5,
  },
  {
    id: 4,
    name: "Carlos Mendes",
    message: "Fizeram a limpeza das cadeiras do escritório todo. Rápido, sem bagunça e ficou show. Parabéns pelo trabalho! 🔝",
    time: "11:20",
    rating: 4,
  },
];
